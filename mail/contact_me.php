...
$headers = implode ("From: contato@lithiumproducoes.com.br\n", "MIME-Version: 1.0","X-Priority: 3","Content-Type: text/html; charset=UTF-8"); // This is the email address the generated message will be from. We recommend using something like noreply@yourdomain.com.
